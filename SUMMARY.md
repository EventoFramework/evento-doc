...
* [Payload](evento-framework/payload/README.md)
  * [Command](evento-framework/payload/command/README.md)
    * [Domain Command](evento-framework/payload/command/domain-command.md)
    * [Service Command](evento-framework/payload/command/service-command.md)
  * [Event](evento-framework/payload/event/README.md)
    * [Domain Event](evento-framework/payload/event/domain-event.md)
    * [ServiceEvent](evento-framework/payload/event/serviceevent.md)
  * [View](evento-framework/payload/view.md)
  * [Query](evento-framework/payload/query/README.md)
    * [Query Response](evento-framework/payload/query/query-response/README.md)
      * [Multiple](evento-framework/payload/query/query-response/multiple.md)
      * [Single](evento-framework/payload/query/query-response/single.md)
